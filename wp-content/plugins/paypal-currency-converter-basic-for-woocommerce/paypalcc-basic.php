...
class ppcc {
    ...
    public function activate() {
		...
		$options['conversion_rate'] = 1.0;//$exrdata;
	...
	$currency_selector='<select id="target_cur" name="'.$this->option_name.'[target_currency]">';
        ...
        echo '<div class="wrap">
            <h2><div class="dashicons dashicons-admin-generic"></div>'. __('PayPal Currency Converter Settings','PPAC').'</h2>
		...
		echo'   <table class="form-table">
			...
			<ul style="list-style-type:circle;border-left-width: 13px;margin-left: 19px;">
				...
				<li> Allows Custom Currency setup</li>
				...
				<li>Supports Multisite setup</li>
			</ul>
		</div>';
